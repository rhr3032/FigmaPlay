import svgPaths from "./svg-m7ee33t64g";

function Body() {
  return (
    <div className="absolute h-[189px] left-0 top-[18px] w-[126px]" data-name="Body">
      <div className="absolute inset-[-0.26%_-0.4%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 127 190">
          <g id="Body">
            <path d={svgPaths.pb286d00} id="Bottom left rounded rectangle" stroke="var(--stroke-0, black)" strokeDasharray="8 8" />
            <path d={svgPaths.p1ce1fd00} fill="var(--fill-0, #FF7237)" id="Rectangle 29" stroke="var(--stroke-0, black)" strokeDasharray="8 8" />
            <path d={svgPaths.p26b7a680} id="Rectangle 30" stroke="var(--stroke-0, black)" strokeDasharray="8 8" />
            <path d={svgPaths.p15156800} id="Rectangle 31" stroke="var(--stroke-0, black)" strokeDasharray="8 8" />
            <rect height="63" id="Bottom right rounded rectangle" rx="31.5" stroke="var(--stroke-0, black)" strokeDasharray="8 8" width="63" x="63.5" y="63.5" />
          </g>
        </svg>
      </div>
    </div>
